...
from src.margin_calculator import StrategyMarginCalculator
...
class DhanBroker(BaseBroker):
    ...
    def __init__(self, client_id: str, pin: str, totp_secret: str):
        ...
        self._strategy_margin = StrategyMarginCalculator(broker=self)
    ...
    def calculate_strategy_margin(self, order_packets: list) -> dict:
        return self._strategy_margin.calculate(order_packets)
